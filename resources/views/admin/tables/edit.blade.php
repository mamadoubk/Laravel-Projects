        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('admin.tables.update', $table->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input class="appearance-none @error('name') border-red-400 @enderror border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{$table->name}}" name="name" id="name" type="text" placeholder="John Doe">
                </div>
                @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input class="appearance-none @error('guest_number') border-red-400 @enderror border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{$table->guest_number}}" name="guest_number" id="guest_number" type="number">
                </div>
                @error('guest_number')
                    <div class="text-sn text-red-40">{{$message}}</div>
                @enderror
